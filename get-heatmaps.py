...
from fastai.vision.image import ResizeMethod
...
def main():
    ...
    path = args.path_base
    path_img_str = args.path_img
    path_hms_str = args.path_hms
    alpha = args.alpha
    ...
    path_img = Path(path_img_str)
    if path_hms_str is not None:
        path_hms = Path(path_hms_str)
    else:
        path_hms = path_img
