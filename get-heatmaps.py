...
def show_heatmap(hm, path, xb_im, y, idx, only_heatmap=False, interpolation='bilinear', alpha=0.5):
...
def generate_heatmaps(path_base, path_img, path_hms=None, alpha=0.5):
    ...
    for idx in range(len(temp.train_ds)):
        ...
        show_heatmap(avg_acts, path_hms, xb_im, y, idx, only_heatmap=False, interpolation='spline16', alpha=alpha)
