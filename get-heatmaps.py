...
def show_heatmap(xb_im, y, idx, hm, path, only_heatmap=False, interpolation='bilinear', alpha=0.5):
...
def generate_heatmaps(learn, data, path_img, path_hms=None, alpha=0.5):
    m = learn.model.eval()
    ...
    for idx in range(len(temp.train_ds)):
        ...
        show_heatmap(xb_im, y, idx, avg_acts, path_hms, only_heatmap=False, interpolation='spline16', alpha=alpha)
...
if __name__ == '__main__':
    ...
    generate_heatmaps(learn, data, path_img, path_hms, alpha)
